...
// Repo root derived from THIS script's location (<repo>/.claude/hooks/) — never
// a hardcoded machine path. 2026-07-17: this was pinned to 'C:/SandyStudio/PLAN.md',
// the desktop's checkout. On any other machine the file did not exist, so the
// fail-safe below silently pinned the mode to ===1=== and would have blocked every
// Write/Edit outside the bypass list, ignoring a Director-granted ===5===.
