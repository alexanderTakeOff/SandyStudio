...
| # | Item | Status |
|---|---|---|
| LT-01 | **Mode 2.5 — APPRENTICE governance**. Agent-led pipeline, Director supervises, conversational control, Skill Editor learning loop. Bridge between Mode 2 and Mode 3 | 🟡 **Phase 1 IN PROGRESS** 2026-05-08+ (quizzical-brown): Prod Assistant + memory + TTS shipped; tool dispatch + pipeline-awareness next. Skill Editor (Path A) deferred per `~/.claude/plans/valiant-soaring-karp.md` |
