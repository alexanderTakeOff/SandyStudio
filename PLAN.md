...
Next:   решение Директора по парадигме: пилот-B на пересмотренной структуре либо
  продолжение на текущей. Открытый долг эпизода: законы дня (единый источник надписи,
  якорь масштаба у признака, смыкание как событие финала, запрет вершины до разворота)
  живут только в промптах SS-S20-E01 — перенести в канон серии и скиллы.
