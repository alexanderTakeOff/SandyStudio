...
Next:   За Директором: три пластины канона (стиль-канон всё ещё flat-2D, Baby-Timer, кроватка)
  и раскол геометрии SH01 (кровать справа против канона). Дальше — планы шотов SH03–SH09
  и видео-фанаут E33. Фаза 1 (прогон 3–4 эпизодов на замороженном стеке) НЕ начата.
