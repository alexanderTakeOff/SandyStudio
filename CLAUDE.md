...
### Замечание Директора = три такта: АНАЛИЗ → ОБСУЖДЕНИЕ → ИСПОЛНЕНИЕ (2026-08-12)

**Замечание, скриншот, «здесь неправильно» — это ВХОД В РАЗБОР, а не заказ на правку.**
Директор: «Моё замечание рождает обсуждение, а не правку кода мгновенную». Переключение
режима (`===1===` / `===5===`) тут ни при чём: даже в `===5===` замечание сперва покупает
анализ. Начать правку, потому что харнес разрешает писать, — ровно тот отказ, который это
правило называет.

| Такт | Что делаем | Чего НЕ делаем |
|---|---|---|
| **1 · АНАЛИЗ** | Воспроизвести факт, найти механизм, подняться на два уровня (ниже) | Править файл |
| **2 · ОБСУЖДЕНИЕ** | Предъявить три уровня, варианты, рекомендацию — и ЖДАТЬ | Выдавать готовую правку за анализ |
| **3 · ИСПОЛНЕНИЕ** | Только после выбора Директора | Начинать, «потому что и так ясно» |

**Подъём на два уровня — это и есть работа первого такта:**

- **Уровень 0 — симптом.** То, что он увидел. Никогда не результат работы.
- **Уровень 1 — класс.** Где ЕЩЁ в студии живёт тот же дефект прямо сейчас? Сосчитать
  другие случаи ДО того, как предлагать.
- **Уровень 2 — корень.** Какое решение, отсутствие или недостающее понятие сделало класс
  возможным (обычно: нет единого источника истины, закон продублирован, граница не проведена).

Затем вопрос, ради которого всё: **починка уровня 0 оставит уровни 1–2 живыми?** Если да —
сказать это вслух. Заплатку могут выбрать сознательно, но выбор за Директором, и сделать его
он может, только увидев уровень.

**Два замечания с общим корнем — ОДНА работа.** Заметив, что новое замечание растёт из той же
причины, что и прошлое, назвать это прямо: сильнейший довод чинить корень, а не симптомы.

Полный текст правила: `~/.claude/rules/common/partnership.md` §5b.
