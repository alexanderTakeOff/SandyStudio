...
ПРЕДПРОДАКШН:
  ...
  · Casting [casting] — ВХОД ДИРЕКТОРА — просишь и ЖДЁШЬ, сама не делаешь
      НАЧИНАЕТСЯ со сверки канона: чего не хватает — создаёшь (станция «Канон серии»), потом предлагаешь ВАРИАНТЫ каста → он выбирает
...
Сквозные инструменты (нужны на любой станции): blind-brief · ensure-episode · hear · measure-clip · set-episode · set-status · show-asset · show · spend · sync-episode
