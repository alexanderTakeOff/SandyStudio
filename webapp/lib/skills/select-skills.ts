 ...
 */
// 2026-08-28 — ПОДНЯТ 5 -> 8 решением Директора. Пятёрка была узким местом
// вместе с бюджетом тел: у EXEC-EREF-DESIGNER x doc совпадало ровно 5 скиллов,
// то есть следующий отскоупленный на эту роль движок вытеснил бы соседа молча.
// Отбор идёт по specificity после hard-скиллов, поэтому запас в три места
// стоит ноль, а его отсутствие стоило жанрового движка.
const MAX_SKILLS_PER_CALL = 8;
